...
def intervene(
    ...
    _echo("")
    _echo("  HOW TO TELL IT WORKED: say anything to Claude Code. If the reply")
    _echo("  does not start with PREFTOOL-CANARY, the restart did not take -")
    _echo("  close the whole editor (or use the terminal: `claude --continue`)")
    _echo("  and try again. Do not continue working until you see it.")
    _echo("=" * 62)
    _echo("")
